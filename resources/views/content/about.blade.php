     ...
     <div class="offcanvas-wrapper">
          ...
          <div class="container">
            ...
            <div class="column">
              <ul class="breadcrumbs">
                <li>{{ Breadcrumbs::render('about') }}</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="container padding-bottom-2x mb-2">
          <div class="row align-items-center padding-bottom-2x">
            <div class="col-md-5"><img class="d-block w-270 m-auto" src="{{ asset('lib/unishop/main/Unishop/template-1/dist/img/features/01.jpg') }}" alt="Online Shopping"></div>
          ...
          <div class="row align-items-center padding-top-2x padding-bottom-2x">
            <div class="col-md-5 order-md-2"><img class="d-block w-270 m-auto" src="{{ asset('lib/unishop/main/Unishop/template-1/dist/img/features/02.jpg') }}" alt="Delivery"></div>
          ...
          <hr>
          <div class="row align-items-center padding-top-2x padding-bottom-2x">
            <div class="col-md-5"><img class="d-block w-270 m-auto" src="{{ asset('lib/unishop/main/Unishop/template-1/dist/img/features/03.jpg') }}" alt="Mobile App"></div>
            <div class="col-md-7 text-md-left text-center">
              <div class="mt-30 hidden-md-up"></div>
          ...
          <hr>
          <div class="row align-items-center padding-top-2x padding-bottom-2x">
            <div class="col-md-5 order-md-2"><img class="d-block w-270 m-auto" src="{{ asset('lib/unishop/main/Unishop/template-1/dist/img/features/04.jpg') }}" alt="Delivery"></div>
            <div class="col-md-7 order-md-1 text-md-left text-center">
              <div class="mt-30 hidden-md-up"></div>
          ...
          <div class="row">
            <div class="col-md-3 col-sm-6 mb-30 text-center"><img class="d-block w-150 mx-auto img-thumbnail rounded-circle mb-2" src="{{ asset('lib/unishop/main/Unishop/template-1/dist/img/team/01.jpg') }}" alt="Team">
              <h6>Grace Wright</h6>
            ...
            <div class="col-md-3 col-sm-6 mb-30 text-center"><img class="d-block w-150 mx-auto img-thumbnail rounded-circle mb-2" src="{{ asset('lib/unishop/main/Unishop/template-1/dist/img/team/02.jpg') }}" alt="Team">
            ...
            <div class="col-md-3 col-sm-6 mb-30 text-center"><img class="d-block w-150 mx-auto img-thumbnail rounded-circle mb-2" src="{{ asset('lib/unishop/main/Unishop/template-1/dist/img/team/03.jpg') }}" alt="Team">
              <h6>Quinton Cross</h6>
            ...
            <div class="col-md-3 col-sm-6 mb-30 text-center"><img class="d-block w-150 mx-auto img-thumbnail rounded-circle mb-2" src="{{ asset('lib/unishop/main/Unishop/template-1/dist/img/team/04.jpg') }}" alt="Team">
              <h6>Liana Mullen</h6>
